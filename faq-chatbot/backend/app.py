...
firebase_key_path = os.getenv("FIREBASE_KEY_PATH", r"D:\farmerproject-106b6-firebase-adminsdk-nmd9t-35a1b1cd47.json")
with open(firebase_key_path) as f:
    firebase_config = json.load(f)
    
cred = credentials.Certificate(firebase_key_path)  # Replace with your Firebase key
